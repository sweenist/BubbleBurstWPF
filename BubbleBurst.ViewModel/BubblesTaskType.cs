...
{
    /// <summary>Represents the various tasks that can be performed on a group of bubbles.</summary>
    public enum BubblesTaskType
    {
        /// <summary>Represents the task of removing the bubbles in a group that was burst by the user.</summary>
        Burst,
        /// <summary>
